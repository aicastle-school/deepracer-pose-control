...
import os
# from flask_cors import CORS  # CORS handled by Nginx
...
# CORS(app)  # Disabled - CORS handled by Nginx
csrf = CSRFProtect()
# Initialize the application with CSRF and register all the API blueprints.
csrf.init_app(app)

# Exempt API endpoints from CSRF protection for external access
csrf.exempt(VEHICLE_CONTROL_BLUEPRINT)
csrf.exempt(DEVICE_INFO_API_BLUEPRINT)
csrf.exempt(LED_API_BLUEPRINT)
